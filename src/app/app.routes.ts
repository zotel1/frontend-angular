...
export const appRoutes: Routes = [
    ...
    { path: 'plants', loadComponent: () => import('./shared/components/plants/plants.component').then(m => m.PlantsComponent), canActivate: [AuthGuard] },
    ...
    { path: 'details', loadComponent: () => import('./business/plants/plant-detail/plant-detail.component').then(m => m.PlantDetailComponent), canActivate: [AuthGuard] },
